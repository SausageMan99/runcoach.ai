    ...
    return (
        <div className="w-full max-w-md space-y-8">
            <div className="space-y-2">
                ...
                <p className="text-muted-foreground">Connecte-toi pour accéder à ton programme</p>
            </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className="pl-11 rounded-xl py-5"
                            {...register('email')}
                        />
                    </div>
            ...
            <p className="text-center text-sm text-muted-foreground">
                ...
                <Link href={`/signup?redirect=${redirect}`} className="text-primary font-medium hover:underline">
                    S&apos;inscrire
                </Link>
            </p>
        </div>
