...
export default function AuthLayout({
    ...
    return (
        <div className="min-h-screen bg-background flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-terracotta/10 via-terracotta-light/10 to-terracotta-dark/5 relative overflow-hidden items-center justify-center p-12">
